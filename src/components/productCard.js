...
import { addCartItem, addWishlistItem } from "../store/actions";
...
function ProductCard({ product, badgeType, ...props }) {
    ...
    >
      ...
      <CardActions sx={{ alignSelf: "end" }}>
        <Tooltip title="Add to cart" arrow>
          <IconButton onClick={() => dispatch(addCartItem(product))}>
            <AddShoppingCartIcon />
          </IconButton>
        </Tooltip>
        <Tooltip title="Add to wishlist" arrow>
          <IconButton onClick={() => dispatch(addWishlistItem(product))}>
            <AddToWishlistIcon />
          </IconButton>
        </Tooltip>
        <Button
